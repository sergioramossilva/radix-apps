...
def try_appmenu_interface(window_id):
  ...
  if 'dmenu' in sys.argv:
    ...
    menu_cmd = subprocess.Popen(['rofi', '-dmenu', '-i', '-location', '1', '-width', '25', '-l', '25', '-scroll-method', '1', '-color-enabled', '-color-window', "#242424, #ffffff", '-color-normal', "#242424, #FFFFFF, #242424, #398ee7", '-separator-style', 'none', '-p', "", '-font', "Lato 10", '-bw', "0", '-yoffset', "24", '-hide-scrollbar', "True", '-xoffset', "24"], stdout=subprocess.PIPE, stdin=subprocess.PIPE)
